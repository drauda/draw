function CanvasDraw(target, options) {
    ...
    window.CTX = fgctx = fgcanvas.getContext("2d");
    ...
    function BeginPolyline(wrapper, id, x, y) {
        ...
        console.log(darkColorNames[Math.floor(Math.random() * darkColorNames.length)])
        foregroundPolylines[id.toString()] = { points: [{ x: x, y: y}], color: COLOR };
        RequestRedraw();
    }
